...
@click.option(
    ...
    type=float,
    show_default=True,
    help="the standard deviation for the noise term in the time-course mode. Higher values result in more smoothing (flatter curves). Lower values result in less smoothing (more jagged fits).",
)
